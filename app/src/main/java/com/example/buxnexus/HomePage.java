...
public class HomePage extends AppCompatActivity {
    ...
    public CardView CVNewPAss,CVBusDetail,CVLocation,CVPassValidity,CVUserDetail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //CVUserDetail = findViewById(R.id.User_detail);
...
//        request.executeAsync();
        ...
        CVUserDetail=findViewById(R.id.User_detail);
        CVUserDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(HomePage.this,user_info.class);
                startActivity(intent);
